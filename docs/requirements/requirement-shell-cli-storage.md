...
**Status**: Active (Version 1.0.1 – domain path fence)  
**Area**: shell  
...
8. Redirect Let's Encrypt private keys or live cert material into `util_resolve_storage` / world-readable scratch roots “for convenience.”  
...
Storage resolve work for certbot-nginx is **not done** if any of the following fail:
