# =============================================================================
# tests/helpers.sh — shared assertions for certbot-nginx CI tests
# =============================================================================
...
: "${SCRIPT:=${REPO_ROOT}/certbot-nginx}"
...
# Isolated HOME + USER_BIN + GLOBAL_BIN (never touch host installs)
ci_isolated_env() {
    CI_HOME=$(mktemp -d "${TMPDIR:-/tmp}/cn-home.XXXXXX")
